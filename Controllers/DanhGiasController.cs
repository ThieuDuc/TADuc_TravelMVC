...
namespace TADuc_TravelMVC.Controllers
{
    public class DanhGiasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Ten,DiaChi,Email,SDT,Mota")] DanhGia danhGia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Ten,DiaChi,Email,SDT,Mota")] DanhGia danhGia)
        {
            if (ModelState.IsValid)
            {
